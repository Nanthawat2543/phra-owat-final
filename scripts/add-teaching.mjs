...
// เทียบเนื้อหาทั้งฉบับ (ตัดช่องว่าง) — เดิมเทียบแค่ 120 ตัวอักษรแรก
// ทำให้พระโอวาทต่างองค์ที่แยกมาจากไฟล์เดียวกัน (ขึ้นต้นด้วยหน้าปกเดียวกัน)
// ถูกปฏิเสธว่าซ้ำทั้งที่เป็นคนละฉบับ
